...
export function organizationSchema() {
  return {
    ...
    email: site.email,
    description: "Asset-based trucking company providing same-day freight delivery, cargo van, box truck, flatbed and dry van service across Florida and the Southeast.",
...
export function jobPostingSchema() {
  return {
    "@context": "https://schema.org",
    "@type": "JobPosting",
    title: "Truck Driver: Box Truck, Cargo Van, Flatbed & Dry Van (Florida, Home Daily)",
    description: "Total Coverage Trucking is hiring non-CDL box truck and cargo van drivers and CDL flatbed and dry van drivers for same-day and regional freight across Florida. Company equipment, home daily on most routes.",
