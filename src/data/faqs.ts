export const faqs = [
  ...
  { q: "What is the cutoff for same-day delivery?", a: "Book by 12:00 PM ET for guaranteed same-day scheduling anywhere in Florida. Later requests are accepted when a truck is nearby." },
  { q: "Do you offer liftgate and inside delivery?", a: "Yes. Every box truck carries a liftgate and pallet jack. Inside delivery is available on request at booking." },
  { q: "Is my freight insured?", a: "Yes. We carry cargo and liability insurance as required for an FMCSA-registered motor carrier. A certificate of insurance is available on request." },
  { q: "Can I get tracking updates?", a: "Yes. Your dispatcher sends pickup confirmation, in-transit updates and a signed proof of delivery by text or email." },
  { q: "Do you handle recurring routes?", a: "Yes. Our Dedicated & Contract Trucking service commits a truck and driver to your schedule at a flat rate." },
  { q: "How do I pay?", a: "New customers pay by card or ACH on delivery. Established accounts move to net terms after the first few shipments." },
];
...
export const driverFaqs = [
  ...
  { q: "What does a typical day look like?", a: "Morning dispatch from your area, one to several stops across Florida, and back home the same day. Multi-stop distribution routes are planned before you leave." },
];
